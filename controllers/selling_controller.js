...
export const postListing = async (req, res) => {
    ...
    await createListing(777, title, category, tags, price, description);//Hardcoded for now
    
}

async function createListing(sellerID, name, categoryName, tags, price, description) {
